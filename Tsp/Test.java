...
public class Test {
	private String cityName[] = { "北京", "上海", "天津", "重庆", "哈尔滨", "长春", "沈阳", "呼浩特", "石家庄", "太原", "济南", "郑州", "西安", "兰州",
			"银川", "西宁", "乌鲁木齐", "合肥", "京", "杭州", "长沙", "南昌", "武汉", "成都", "贵州", "福建", "台北", "广州", "海口", "南宁", "明", "拉萨",
			"香港", "澳门" };
	 ...
	 * @param x
	 *            数组
	 * @return x数组的值是否全部相等,相等则表示x.length代的最优结果相同,则算法 束
	 */
